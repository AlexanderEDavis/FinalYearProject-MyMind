...
extension LoginView {
    ...
    func handleCustomSignIn() {
        // set the interactive auth delegate to self, since this view controller handles the LoginView process for user pools
...
extension LoginView: AWSCognitoIdentityInteractiveAuthenticationDelegate {
    
    // this function handles the UI setup for initial LoginView screen, in our case, since we are already on the LoginView screen, we just return the View Controller instance
...
extension LoginView: AWSCognitoIdentityPasswordAuthentication {
...
extension LoginView: AWSCognitoUserPoolsSignInHandler {
